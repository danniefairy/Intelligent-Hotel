...
<?php
					...
					$db_id=$_SESSION['db_id'];
						...
						if(isset($_POST['replenishment'])){
							...
							$r_name=$_POST['r_name'];
							$r_update="UPDATE `commodity` SET `quantity`=\"$r_q\" WHERE `db_id_name`=\"$r_name\"";
							mysqli_query($connect,$r_update);
						}
					...
					<div class="menu_block">
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								...
								<li class="current"><a href="https://danniehotel.azurewebsites.net/Home/shop_register/index.php">Store Management</a></li>
